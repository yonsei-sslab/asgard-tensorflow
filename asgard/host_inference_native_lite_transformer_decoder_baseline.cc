...
{
  int num_rknn_models = 14;
  int num_tfl_models = 3;

  int loop_count = 1;
  if (argc > (num_rknn_models + num_tfl_models + 1)) {
    loop_count = atoi(argv[num_rknn_models + num_tfl_models + 1]);
  }

  if (argc < (num_rknn_models + num_tfl_models + 1)) {
    printf("Usage:%s rknn_models... tfl_models... [loop_count]\n", argv[0]);
    return -1;
  }
  ...
  for (int cnt = 0; cnt < loop_count; cnt++) {
    ...
    for (int token_cnt = 0; token_cnt < 16; token_cnt++) {
        ...
        memset(input_mems[8][0]->virt_addr, 2, input_mems[8][0]->size);
        memset(input_mems[12][0]->virt_addr, 2, input_mems[12][0]->size);
        ...
        for (int i = 0; i < 3; ++i) {
            // We start from b1-1-2 and c1-1-3
            rknn_index = 0;
            tfl_index = 0;
            ...
            // b1-1-3: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);      // Copy from b1-1-2 fragment (rknn_index: 1)
            ...
            // b1-1-4: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-2][0]->virt_addr, output_mems[rknn_index-2][0]->size);      // Copy from b1-1-2 fragment (rknn_index: 1)
            ...
            // b1-1-5: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-3][0]->virt_addr, output_mems[rknn_index-3][0]->size);      // Copy from b1-1-2 fragment (rknn_index: 1)
            ...
            memcpy(tfl_input_tensors[0], output_mems[rknn_index-2][0]->virt_addr, output_mems[rknn_index-2][0]->size);      // Copy from b1-1-3 fragment (rknn_index: 2)
            memcpy(tfl_input_tensors[1], output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);      // Copy from b1-1-4 fragment (rknn_index: 3)
            ...
            memcpy(input_mems[rknn_index][1]->virt_addr, output_mems[rknn_index-6][0]->virt_addr, output_mems[rknn_index-6][0]->size);                    // Copy from c1-1-1 fragment (rknn_index: 0)
            memcpy(input_mems[rknn_index][2]->virt_addr, output_mems[rknn_index-6][1]->virt_addr, output_mems[rknn_index-6][1]->size);                    // Copy from c1-1-1 fragment (rknn_index: 0)
            ...
            rknn_index++;
            memcpy(input_mems[rknn_index][1]->virt_addr, output_mems[rknn_index-3][0]->virt_addr, output_mems[rknn_index-3][0]->size);        // Copy from b1-1-5 fragment (rknn_index: 4)
            memcpy(input_mems[rknn_index][2]->virt_addr, output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);        // Copy from c1-1-6 fragment (rknn_index: 6)
            ...
            // b1-2-2: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-2][1]->virt_addr, output_mems[rknn_index-2][1]->size);        // Copy from c1-1-7 fragment (rknn_index: 7)
            memcpy(input_mems[rknn_index][1]->virt_addr, output_mems[rknn_index-8][0]->virt_addr, output_mems[rknn_index-8][0]->size);        // Copy from b1-1-2 fragment (rknn_index: 1)
            ...
            // b1-2-3: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);        // Copy from b1-2-2 fragment (rknn_index: 9)
            ...
            // b1-2-4: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);        // Copy from b1-2-3 fragment (rknn_index: 10)
            ...
            // b1-2-6: Copy intermediate results
            rknn_index++;
            memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);        // Copy from b1-2-5 fragment (rknn_index: 12)
            ...
            memcpy(tfl_input_tensors[0], output_mems[rknn_index-2][0]->virt_addr, output_mems[rknn_index-2][0]->size);        // Copy from b1-2-4 fragment (rknn_index: 11)
            memcpy(tfl_input_tensors[1], output_mems[rknn_index-5][1]->virt_addr, output_mems[rknn_index-5][1]->size);        // Copy from c1-2-1 fragment (rknn_index: 8)
            memcpy(tfl_input_tensors[2], output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);        // Copy from b1-2-5 fragment (rknn_index: 12)
            memcpy(tfl_input_tensors[3], output_mems[rknn_index][0]->virt_addr, output_mems[rknn_index][0]->size);            // Copy from b1-2-6 fragment (rknn_index: 13)
            memcpy(tfl_input_tensors[4], output_mems[rknn_index-3][0]->virt_addr, output_mems[rknn_index-3][0]->size);        // Copy from b1-2-3 fragment (rknn_index: 10)
            memcpy(tfl_input_tensors[5], output_mems[rknn_index-5][0]->virt_addr, output_mems[rknn_index-5][0]->size);        // Copy from c1-2-1 fragment (rknn_index: 8)
