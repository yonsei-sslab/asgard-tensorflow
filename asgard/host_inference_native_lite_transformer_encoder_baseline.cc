...
int main(int argc, char* argv[])
{
  ...
  for (int cnt = 0; cnt < loop_count; cnt++) {
    ...
    // b1-3: Copy intermediate results
    rknn_index++;
    memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-1][1]->virt_addr, output_mems[rknn_index-1][1]->size);      // Copy from b1-2 fragment (rknn_index: 1)
    ...
    // b1-4: Copy intermediate results
    rknn_index++;
    memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-2][1]->virt_addr, output_mems[rknn_index-2][1]->size);      // Copy from b1-2 fragment (rknn_index: 1)
    ...
    memcpy(tfl_input_tensors[0], output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);       // Copy from b1-3 fragment (rknn_index: 2)
    memcpy(tfl_input_tensors[1], output_mems[rknn_index-2][0]->virt_addr, output_mems[rknn_index-2][0]->size);       // Copy from b1-2 fragment (rknn_index: 1)
    ...
    memcpy(input_mems[rknn_index][1]->virt_addr, output_mems[0][0]->virt_addr, output_mems[0][0]->size);                                              // Copy from c1 fragment (rknn_index: 0)
    memcpy(input_mems[rknn_index][2]->virt_addr, output_mems[0][1]->virt_addr, output_mems[0][1]->size);                                              // Copy from c1 fragment (rknn_index: 0)
    ...
    memcpy(tfl_input_tensors[0], output_mems[rknn_index][0]->virt_addr, output_mems[rknn_index][0]->size);         // Copy from c1-4 fragment (rknn_index: 4)
    memcpy(tfl_input_tensors[1], output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);     // Copy from b1-4 fragment (rknn_index: 3)
    ...
    rknn_index++;
    memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-4][1]->virt_addr, output_mems[rknn_index-4][1]->size);                    // Copy from b1-2 fragment (rknn_index: 1)
    ...
    for (int i = 0; i < 4; ++i) {
        // b1-2: Copy intermediate results
        rknn_index++;
        ...
        // b1-3: Copy intermediate results
        rknn_index++;
        memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-1][1]->virt_addr, output_mems[rknn_index-1][1]->size);      // Copy from b1-2 fragment (rknn_index: 5)
        ...
        // b1-4: Copy intermediate results
        rknn_index++;
        memcpy(input_mems[rknn_index][0]->virt_addr, output_mems[rknn_index-2][1]->virt_addr, output_mems[rknn_index-2][1]->size);      // Copy from b1-2 fragment (rknn_index: 5)
        ...
        memcpy(tfl_input_tensors[0], output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);       // Copy from b1-3 fragment (rknn_index: 6)
        memcpy(tfl_input_tensors[1], output_mems[rknn_index-2][0]->virt_addr, output_mems[rknn_index-2][0]->size);       // Copy from b1-2 fragment (rknn_index: 5)
        ...
        // c1-4: Copy intermediate results
        rknn_index++;
        memcpy(input_mems[rknn_index][0]->virt_addr, tfl_interpreter[tfl_index]->typed_output_tensor<float>(0), input_mems[rknn_index][0]->size);         // Copy from c1-3 fragment (tfl_index: 2)
        memcpy(input_mems[rknn_index][1]->virt_addr, output_mems[0][0]->virt_addr, output_mems[0][0]->size);                                              // Copy from c1 fragment (rknn_index: 0)
        memcpy(input_mems[rknn_index][2]->virt_addr, output_mems[0][1]->virt_addr, output_mems[0][1]->size);                                              // Copy from c1 fragment (rknn_index: 0)
        ...
        memcpy(tfl_input_tensors[1], output_mems[rknn_index-1][0]->virt_addr, output_mems[rknn_index-1][0]->size);     // Copy from b1-4 fragment (rknn_index: 7)
        memcpy(tfl_input_tensors[0], output_mems[rknn_index][0]->virt_addr, output_mems[rknn_index][0]->size);         // Copy from c1-4 fragment (rknn_index: 8)
